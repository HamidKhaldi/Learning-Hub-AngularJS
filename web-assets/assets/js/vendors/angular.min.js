        ...
        this.$get = [
            ...
            function (d, c) {
                function e(a, b) {
                    var c;
                    "self" === a
                        ? (c = Cc(b, Qd)) || (z.document.baseURI ? (c = z.document.baseURI) : (Na || ((Na = z.document.createElement("a")), (Na.href = "."), (Na = Na.cloneNode(!1))), (c = Na.href)), (c = Cc(b, c)))
                        : (c = !!a.exec(b.href));
                    return c;
                }
                function f(a) {
                            ...
                            A
                                ...
                                : ((n.writeValue = function (a) {
                                      if (v) {
                                          ...
                                          c
                                              ? (k[0].value !== c.selectValue && (n.removeUnknownOption(), (k[0].value = c.selectValue), (c.element.selected = !0)), c.element.setAttribute("selected", "selected"))
...
//
(function(window,angular){'use strict';var $sanitizeMinErr=angular.$$minErr('$sanitize');var bind;var extend;var forEach;var isDefined;var lowercase;var noop;var htmlParser;var htmlSanitizeWriter;function $SanitizeProvider(){var svgEnabled=!1;this.$get=['$$sanitizeUri',function($$sanitizeUri){if(svgEnabled){extend(validElements,svgElements)}
